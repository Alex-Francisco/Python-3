## Exercício 46 do livro Python 3 - Conceitos e Aplicações - Uma Abordagem Didática
""" Escreva um programa que leia do teclado duas matrizes de dimensões 2x2 e mostre na tela a soma dessas duas matrizes. """
...
print("\n")
print("=="*29)
print("A soma das duas matrizes resulta em;")
print("=="*29)
print("\n")
